  ...
  >
    ...
    <div className="absolute inset-0 flex justify-center items-center z-0">
      <div className="w-[300px] h-[300px] lg:w-[400px] lg:h-[400px] relative opacity-20 select-none">
        <span className="text-[300px] lg:text-[400px] font-bold text-golden leading-none flex items-center justify-center">
          B
        </span>
      </div>
    </div>
    ...
    <div className="w-full max-w-[1300px] z-10 flex flex-col lg:flex-row justify-center items-center lg:items-start w-full gap-8 lg:gap-16">
      <div className="flex-1 flex flex-col justify-center items-center text-center lg:justify-end lg:items-end lg:text-right">
