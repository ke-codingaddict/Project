...
const AboutUs = () => (
  ...
  >
    <div
      className="absolute inset-0 bg-[url('/bg.png')] bg-cove-
    
    r bg-center bg-fixed z-0"
    />
    ...
    <div className="w-full max-w-[1300px] z-10 flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 lg:gap-0 px-4">
      <div className="w-full lg:w-fit flex flex-col justify-center items-center text-center lg:justify-end lg:items-end lg:text-right">
      ...
      <div className="w-full lg:w-fit flex flex-col justify-center items-center text-center lg:justify-start lg:items-start lg:text-left">
